...
export function AdminService({ onMenuClick }: AdminServiceProps) {
  const { createAdminService, loading } = useAdminServices();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await createAdminService(serviceData);
    if (result.success) {
      // Reset form
      setFormData({
        model_name: '',
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Admin Service Management</h1>
          <p className="text-gray-600">Create and manage service records</p>
        </div>
        <button
          onClick={onMenuClick}
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Service Record</h2>
              <p className="text-gray-600">Fill in the service information</p>
            </div>
          </div>
